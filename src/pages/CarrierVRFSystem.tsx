...
const products = [
  {
    image: "/images/carrier/vrf/vrf.jpg",
    title: "VRF System",
  },
];

const CarrierVRFSystem = () => {
  return (
    <div>
      <PageBanner title="Carrier VRF System" breadcrumb="Carrier VRF System" />
...
export default CarrierVRFSystem;
